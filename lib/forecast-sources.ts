...
import { metNorwayUrl, parseLocationForecast } from './met-norway';
...
// MET Norway is its own module, lib/met-norway.ts: the week strip aggregates
// the same response, so the URL, the validator and the frozen-share rule are
// shared from there rather than reached into here.
