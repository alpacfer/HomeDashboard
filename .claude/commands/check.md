...
allowed-tools: Bash(npm run check), Bash(npm run lint), Bash(npm run typecheck), Bash(npm test), Bash(npm run docs:check), Bash(npm run check:rules), Bash(npm run build)
---
